...
<table width="100%" height="160" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#D9E9FF"
       style="border-collapse:collapse">
    <TBODY>
    <TR
            align=middle bgColor=#ffffff>
        <td colspan="4" bgColor=#CADCEA><strong>基本信息</strong></td>
    </TR>
    <TR align=middle
        bgColor=#ffffff>
...
<table width="100%" height="193" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#D9E9FF"
    ...
    <TR
            align=middle bgColor=#ffffff>
        <td colspan="2" bgColor=#CADCEA><strong>选课系统</strong></td>
    </TR>
    <TR align=middle
        bgColor=#ffffff>
        <TD width="10%" align="left">系统作者：</TD>
        <TD width="41%" align="left"><font class="t4">曾令浩</font></TD>
    </TR>

    <TR align=middle
        bgColor=#ffffff>
        <TD align="left">联系方式：</TD>
        <TD align="left"><font class="t41">linghao.z@foxmail.com</font></TD>
    </TR>
    </TBODY>
</TABLE>
<p>&nbsp;</p>
